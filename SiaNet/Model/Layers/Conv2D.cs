...
namespace SiaNet.Model.Layers
{
    ...
    public class Conv2D : LayerConfig
    {
        ...
        public Conv2D(int channels, Tuple<int, int> kernalSize, Tuple<int, int, int> shape = null, Tuple<int, int> strides = null, bool padding = true, Tuple<int, int> dialation = null, 
